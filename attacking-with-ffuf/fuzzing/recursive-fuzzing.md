...
## <mark style="color:red;">Recursive Flags</mark>
...
## <mark style="color:red;">Recursive Scanning</mark>
...
```shell-session
mrroboteLiot@htb[/htb]$ ffuf -w /opt/useful/seclists/Discovery/Web-Content/directory-list-2.3-small.txt:FUZZ -u http://SERVER_IP:PORT/FUZZ -recursion -recursion-depth 1 -e .php -v
